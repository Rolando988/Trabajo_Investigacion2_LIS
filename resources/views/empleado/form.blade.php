...
<div class="form-group">
<label for="ApeliidoMaterno">Apeliido Materno</label>
<input type="text" class="form-control" name ="ApeliidoMaterno" value="{{ isset($empleado->ApeliidoMaterno)?$empleado->ApeliidoMaterno:old('ApeliidoMaterno') }}" id="ApeliidoMaterno">
